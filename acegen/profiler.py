...
class Profiler:
    ...
    def add_metrics(self, key, elapsed_time, memory_change, end_mem, reserve_change, reserved_mem, cpu_memory_change, end_cpu_mem):
        """
    ...
    def report(self, average=True):
        ...
        if df.empty:
            ...
            average_df = df.groupby("key", sort=False).agg(
                {
                    "elapsed_time (s)": "mean",
...
class SimpleProfiler:
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        self.parent_profiler.add_metrics(self.key, elapsed_time, memory_change, end_mem, reserve_change, reserved_mem, cpu_memory_change, end_cpu_mem)
