...
def main(cfg: "DictConfig"):
    ...
    for data in collector:
        ...
        assert data["recurrent_state_c"].sum() != 0.0  # This is False when I use parallel envs
        assert data["next"]["recurrent_state_c"].sum() != 0.0  # This is False when I use parallel envs
